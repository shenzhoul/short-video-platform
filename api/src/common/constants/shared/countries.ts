/**
 * ISO2 country codes array for validation
 * Complete list including Kosovo (XK) for form validation
 */
export const COUNTRIES_ISO2_CODE = [
  ...
  'KZ', 'KE', 'KI', 'KR', 'KP', 'KW', 'KG', 'LA', 'LV', 'LB', 'LS', 'LR', 'LY', 'LI', 'LT', 'LU',
