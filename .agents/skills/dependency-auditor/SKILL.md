...
description: Audit project dependencies for security, license, and upgrade risk. Use when scanning dependencies for vulnerabilities/CVEs, checking license compliance and conflicts, finding outdated or unused/bloated packages, planning safe upgrade paths, or assessing supply-chain risk across npm/yarn, pip/poetry, Go, Cargo, Maven/Gradle, Composer, and more.
---
