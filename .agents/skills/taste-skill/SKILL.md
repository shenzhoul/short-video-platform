---
name: taste-skill
description: Anti-slop frontend skill for landing pages, portfolios, marketing/public pages, and redesigns. Reads the brief, infers the right design direction, and ships interfaces that do not look templated. Use for high-craft public/marketing UI in user/ or admin/; for app-internal dashboards/data tables prefer frontend-design. Real design systems when applicable, audit-first on redesigns, strict pre-flight check.
license: MIT
metadata:
  source: https://github.com/Leonxlnx/taste-skill (taste-skill)
  vendored: true
---
