...
description: Review REST API design for convention compliance, breaking changes, and consistency. Use when reviewing endpoint design, checking response/DTO and error-format consistency, validating naming/versioning/pagination/status codes, detecting breaking changes between API versions, or scoring overall API design quality.
---
