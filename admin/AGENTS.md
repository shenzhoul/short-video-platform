# Douyin Clone Admin Agent Guide
...
- Add or update targeted unit tests for the changed behavior. Keep the tests focused on the task; they do not need broad coverage when the change is narrow.
